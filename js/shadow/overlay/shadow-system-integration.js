...
(function (global) {
    ...
    function updateShadowIndicator(shadows, source = 'template') {
        ...
        Logger.info('Shadow:SystemIntegration', `Updated: ${currentShadows.length} shadows (source: ${source})`);
    }
    ...
    function initShadowEventListener() {
        ...
        Logger.debug('Shadow:SystemIntegration', 'Event listener registered: shadows-updated');
    }
    ...
    function startSyncInterval(intervalMs = 10000) {
        ...
        Logger.info('Shadow:SystemIntegration', `Sync interval started (${intervalMs}ms)`);
    }
    ...
    function stopSyncInterval() {
        if (syncIntervalId) {
            clearInterval(syncIntervalId);
            syncIntervalId = null;
            Logger.info('Shadow:SystemIntegration', 'Sync interval stopped');
        }
    }
    ...
    function hookShadowPanel() {
        ...
        if (originalShadowPanelUpdate) {
            ...
            Logger.debug('Shadow:SystemIntegration', 'Hooked into shadowPanel.update()');
        }
    }
    ...
    function cleanup() {
        ...
        Logger.info('Shadow:SystemIntegration', 'Cleaned up (interval stopped, state saved)');
    }
    ...
    Logger.debug('Shadow:SystemIntegration', 'Module loaded');
