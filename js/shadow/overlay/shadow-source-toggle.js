...
(function (global) {
    ...
    class ShadowSourceToggle {
        ...
        constructor(container) {
            ...
            if (!this.container) {
                Logger.warn('Shadow:SourceToggle', 'Container not found - toggle disabled');
                return;
            }
            ...
            Logger.info('Shadow:SourceToggle', `🔄 Initialized in ${this.mode} mode`);
        }
        ...
        refresh() {
            ...
            Logger.info('Shadow:SourceToggle', `🔄 Mode changed: ${this.mode} → ${newMode}`);
            this.mode = newMode;
        ...
        `;
            ...
            Logger.debug('Shadow:SourceToggle', 'Toggle HTML restored (compact with tooltip)');
        }
        ...
        renderNormalToggle(shadowState) {
            ...
            Logger.info('Shadow:SourceToggle', `Template mode: ${shadowState.templateShadows.length} patterns`);
        }
        ...
        renderCustomDataMode(shadowState) {
            ...
            Logger.info('Shadow:SourceToggle', 'Custom data mode: AI analysis recommended');
        }
        ...
        showFirstUseHint() {
            ...
            if (!localStorage.getItem(STORAGE_KEY)) {
                ...
                Logger.debug('Shadow:SourceToggle', '✨ First-use hint shown');
            }
        }
        ...
        async handleToggle() {
            ...
            if (shadowState.aiGenerationStatus === 'generating') {
                Logger.warn('Shadow:SourceToggle', 'Toggle blocked - generation in progress');
                return;
            }
        ...
        async generateAIShadows() {
            ...
            if (this.loadingText) {
                ...
                Logger.debug('Shadow:SourceToggle', 'Loading text shown');
            }
            ...
            try {
                ...
                if (aiShadows && aiShadows.length > 0) {
                    ...
                    Logger.info('Shadow:SourceToggle', `✨ Generated ${aiShadows.length} AI shadow patterns`);
                ...
                // ─────────────────────────────────────────────────────────────
                Logger.error('Shadow:SourceToggle', 'AI generation failed:', error);
                ...
                if (this.loadingText) {
                    ...
                    Logger.debug('Shadow:SourceToggle', 'Loading text hidden (finally block)');
                }
            }
        }
        ...
        switchSource(newSource) {
            ...
            if (!validSources.includes(newSource)) {
                Logger.error('Shadow:SourceToggle', `Invalid source: ${newSource}, falling back to 'template'`);
                newSource = 'template';
            }
            ...
            Logger.info('Shadow:SourceToggle', `Switched to ${newSource} (${currentShadows.length} shadows)`);
        }
    ...
    Logger.debug('Shadow:SourceToggle', 'Module loaded');
