...
(function () {
    ...
    if (typeof window !== 'undefined') {
        ...
        Logger.info('OctaveIntegrityCalculator', 'Octave Integrity Calculator loaded');
        Logger.debug('OctaveIntegrityCalculator', `Unified thresholds: ${_unifiedThresholds ? 'YES' : 'Using fallback definitions'}`);
        Logger.debug('OctaveIntegrityCalculator', 'Use OctaveIntegrityCalculator.calculateOrganizationalOctave(faces) to compute org octave');
    }
