...
window.CompanyTemplatesBundle = {
    ...
    templates: {
        'quannex': {
            ...
            // Sprint 3 Task 28: Full edge data for 3D hover questions (41 edges from mapping-context.json)
            edges: [
                ...
                { id: 'E2-7', faceIds: [2, 7], emergentName: 'Story Substance Bridge', elementalNature: 'Air', theQuestion: 'Does our brand story match our intellectual substance?', tension: 0.19 },
                ...
                { id: 'E3-8', faceIds: [3, 8], emergentName: 'Being-Doing Balance', elementalNature: 'Fire', theQuestion: 'Does our human energy sustainably fuel our operations?', tension: 0.06 },
                ...
                { id: 'E4-10', faceIds: [4, 10], emergentName: 'Governance Values Bridge', elementalNature: 'Ether', theQuestion: 'Does our governance embody our deepest values?', tension: 0.17 },
                { id: 'E5-6', faceIds: [5, 6], emergentName: 'Market-Community Bridge', elementalNature: 'Water', theQuestion: 'Is there healthy flow between our market presence and community?', tension: 0.20 },
                ...
                { id: 'E5-10', faceIds: [5, 10], emergentName: 'Truth Resonance', elementalNature: 'Ether', theQuestion: 'Does our market perception align with our inner truth?', tension: 0.37 },
                { id: 'E5-11', faceIds: [5, 11], emergentName: 'Funding Signal Clarity', elementalNature: 'Air', theQuestion: 'Does our market clarity attract aligned funding?', tension: 0.08 },
                ...
                { id: 'E6-11', faceIds: [6, 11], emergentName: 'Network Funding Pipeline', elementalNature: 'Water', theQuestion: 'Does our network generate funding opportunities?', tension: 0.12 },
                ...
                { id: 'E7-11', faceIds: [7, 11], emergentName: 'Brand Funding Attraction', elementalNature: 'Air', theQuestion: 'Does our brand story attract aligned capital?', tension: 0.08 },
                { id: 'E7-12', faceIds: [7, 12], emergentName: 'Brand Resilience', elementalNature: 'Fire', theQuestion: 'Is our brand a source of resilience in crisis?', tension: 0.01 },
                { id: 'E8-9', faceIds: [8, 9], emergentName: 'Operations-Values Bridge', elementalNature: 'Water', theQuestion: 'Is there healthy regenerative flow in our operations?', tension: 0.22 },
                ...
                { id: 'E9-10', faceIds: [9, 10], emergentName: 'Values Embodiment', elementalNature: 'Ether', theQuestion: 'Is our regenerative impulse grounded in our core values?', tension: 0.02 },
            ...
            vertices: [
                { id: 'V1', faceIds: [1, 2, 3], emergentName: 'Resourced Innovation Hub', vortexStrength: 0.12, classification: 'synergy_hub', tooltip: 'Where capital, knowledge, and humanity converge' },
                { id: 'V2', faceIds: [1, 3, 4], emergentName: 'Structural Foundation Point', vortexStrength: 0.08, classification: 'neutral', tooltip: 'Where resources, people, and structure meet' },
                { id: 'V3', faceIds: [1, 4, 5], emergentName: 'Market Structure Bridge', vortexStrength: 0.20, classification: 'hotspot', tooltip: 'CAUTION: Market clarity (0.05) drags down this vertex' },
                { id: 'V4', faceIds: [1, 5, 6], emergentName: 'Community Market Capital', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Where financial, market, and community meet' },
                { id: 'V5', faceIds: [1, 2, 6], emergentName: 'Knowledge Capital Network', vortexStrength: 0.10, classification: 'synergy_hub', tooltip: 'Where intellectual capital flows to community' },
                { id: 'V6', faceIds: [2, 3, 8], emergentName: 'Team Learning Junction', vortexStrength: 0.11, classification: 'synergy_hub', tooltip: 'Where team learns together through operations' },
                { id: 'V7', faceIds: [3, 4, 9], emergentName: 'Human Governance Values', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Where people, structure, and values intersect' },
                { id: 'V8', faceIds: [4, 5, 10], emergentName: 'Structural Truth Point', vortexStrength: 0.22, classification: 'hotspot', tooltip: 'CAUTION: Market clarity creates imbalance here' },
                { id: 'V9', faceIds: [5, 6, 11], emergentName: 'Network Market Pipeline', vortexStrength: 0.14, classification: 'neutral', tooltip: 'Where market, community, and funding meet' },
                { id: 'V10', faceIds: [2, 6, 7], emergentName: 'Knowledge Brand Community', vortexStrength: 0.08, classification: 'synergy_hub', tooltip: 'Where IP, partners, and brand converge' },
                { id: 'V11', faceIds: [2, 7, 8], emergentName: 'Brand Knowledge Operations', vortexStrength: 0.09, classification: 'synergy_hub', tooltip: 'Where thesis informs brand and operations' },
                { id: 'V12', faceIds: [3, 8, 9], emergentName: 'Human Operations Values', vortexStrength: 0.18, classification: 'neutral', tooltip: 'Where founder energy meets regenerative work' },
                { id: 'V13', faceIds: [4, 9, 10], emergentName: 'Governance Values Regeneration', vortexStrength: 0.10, classification: 'synergy_hub', tooltip: 'Strong values alignment at this vertex' },
                { id: 'V14', faceIds: [5, 10, 11], emergentName: 'Market Values Pipeline', vortexStrength: 0.25, classification: 'bermuda_triangle', tooltip: 'CRITICAL: Market weakness (0.05) creates severe imbalance' },
                { id: 'V15', faceIds: [6, 7, 11], emergentName: 'Community Brand Funding', vortexStrength: 0.12, classification: 'neutral', tooltip: 'Where network influences funding pursuit' },
                { id: 'V16', faceIds: [7, 8, 12], emergentName: 'Brand Operations Resilience', vortexStrength: 0.01, classification: 'synergy_hub', tooltip: 'EXCELLENT: Near-perfect balance between brand, ops, resilience' },
                { id: 'V17', faceIds: [8, 9, 12], emergentName: 'Operations Regeneration Resilience', vortexStrength: 0.16, classification: 'neutral', tooltip: 'Where daily work meets regenerative resilience' },
                { id: 'V18', faceIds: [9, 10, 12], emergentName: 'Values Regeneration Fortress', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Where values and regeneration build resilience' },
                { id: 'V19', faceIds: [10, 11, 12], emergentName: 'Values Pipeline Resilience', vortexStrength: 0.20, classification: 'hotspot', tooltip: 'CAUTION: Weak funding pipeline creates strain' },
                { id: 'V20', faceIds: [7, 11, 12], emergentName: 'Brand Funding Fortress', vortexStrength: 0.05, classification: 'synergy_hub', tooltip: 'Brand and resilience support funding pursuit' }
            ],
        ...
        'nova-tech': {
            ...
            // Full edge data from mapping-context.json
            edges: [
                ...
                { id: 'E2-7', faceIds: [2, 7], emergentName: 'Hidden Innovation', elementalNature: 'Air', theQuestion: 'Does our brand story match our intellectual substance?', tension: 0.55 },
                ...
                { id: 'E3-8', faceIds: [3, 8], emergentName: 'Burnout Engine', elementalNature: 'Fire', theQuestion: 'Does our human energy sustainably fuel our operations?', tension: 0.23 },
                ...
                { id: 'E4-10', faceIds: [4, 10], emergentName: 'Values Need Structure', elementalNature: 'Ether', theQuestion: 'Does our governance embody our deepest values?', tension: 0.34 },
                { id: 'E5-6', faceIds: [5, 6], emergentName: 'Silent Community', elementalNature: 'Water', theQuestion: 'Is there healthy flow between our market presence and community?', tension: 0.09 },
                ...
                { id: 'E5-10', faceIds: [5, 10], emergentName: 'Truth Without Audience', elementalNature: 'Ether', theQuestion: 'Does our market perception align with our inner truth?', tension: 0.46 },
                { id: 'E5-11', faceIds: [5, 11], emergentName: 'Fundraising Without Story', elementalNature: 'Air', theQuestion: 'Does our market clarity attract aligned funding?', tension: 0.26 },
                ...
                { id: 'E6-11', faceIds: [6, 11], emergentName: 'Network to Funding', elementalNature: 'Water', theQuestion: 'Does our network generate funding opportunities?', tension: 0.17 },
                ...
                { id: 'E7-11', faceIds: [7, 11], emergentName: 'Pitch Without Identity', elementalNature: 'Air', theQuestion: 'Does our brand story attract aligned capital?', tension: 0.22 },
                { id: 'E7-12', faceIds: [7, 12], emergentName: 'Brand Fragility', elementalNature: 'Fire', theQuestion: 'Is our brand a source of resilience in crisis?', tension: 0.05 },
                { id: 'E8-9', faceIds: [8, 9], emergentName: 'Operations vs Values', elementalNature: 'Water', theQuestion: 'Is there healthy regenerative flow in our operations?', tension: 0.15 },
                ...
                { id: 'E9-10', faceIds: [9, 10], emergentName: 'Values Grounding', elementalNature: 'Ether', theQuestion: 'Is our regenerative impulse grounded in our core values?', tension: 0.32 },
            ...
            vertices: [
                { id: 'V1', faceIds: [1, 2, 3], emergentName: 'Brilliant Burnout Triangle', vortexStrength: 0.45, classification: 'bermuda_triangle', tooltip: 'CRITICAL: Strong IP (0.65) vs exhausted founders (0.12) vs no cash (0.08)' },
                { id: 'V2', faceIds: [1, 3, 4], emergentName: 'Structural Survival Point', vortexStrength: 0.08, classification: 'neutral', tooltip: 'All three faces struggling at survival level' },
                { id: 'V3', faceIds: [1, 4, 5], emergentName: 'Market Structure Gap', vortexStrength: 0.10, classification: 'neutral', tooltip: 'Market invisibility compounds structural weakness' },
                { id: 'V4', faceIds: [1, 5, 6], emergentName: 'Community Capital Void', vortexStrength: 0.07, classification: 'neutral', tooltip: 'Weak across all three survival dimensions' },
                { id: 'V5', faceIds: [1, 2, 6], emergentName: 'Innovation Without Support', vortexStrength: 0.40, classification: 'hotspot', tooltip: 'Strong IP isolated from funding and community' },
                { id: 'V6', faceIds: [2, 3, 8], emergentName: 'Burnout Engine Vertex', vortexStrength: 0.35, classification: 'bermuda_triangle', tooltip: 'CRITICAL: Founders pouring energy into IP at expense of health' },
                { id: 'V7', faceIds: [3, 4, 9], emergentName: 'Survival Values Junction', vortexStrength: 0.08, classification: 'neutral', tooltip: 'Trying to maintain values while surviving' },
                { id: 'V8', faceIds: [4, 5, 10], emergentName: 'Hidden Mission Point', vortexStrength: 0.35, classification: 'hotspot', tooltip: 'Strong values (0.52) but invisible to market (0.06)' },
                { id: 'V9', faceIds: [5, 6, 11], emergentName: 'Pipeline Visibility Gap', vortexStrength: 0.18, classification: 'neutral', tooltip: 'Fundraising without market presence' },
                { id: 'V10', faceIds: [2, 6, 7], emergentName: 'IP Brand Network', vortexStrength: 0.42, classification: 'hotspot', tooltip: 'Strong IP (0.65) completely invisible externally' },
                { id: 'V11', faceIds: [2, 7, 8], emergentName: 'Product Without Story', vortexStrength: 0.38, classification: 'hotspot', tooltip: 'Working product but no brand narrative' },
                { id: 'V12', faceIds: [3, 8, 9], emergentName: 'Exhausted Operations', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Operations running on founder fumes' },
                { id: 'V13', faceIds: [4, 9, 10], emergentName: 'Values Structure Gap', vortexStrength: 0.26, classification: 'hotspot', tooltip: 'Clear values but uncodified structure' },
                { id: 'V14', faceIds: [5, 10, 11], emergentName: 'Mission Funding Bridge', vortexStrength: 0.35, classification: 'hotspot', tooltip: 'Strong mission (0.52) could attract aligned investors if visible' },
                { id: 'V15', faceIds: [6, 7, 11], emergentName: 'Network Pitch Junction', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Building investor relationships slowly' },
                { id: 'V16', faceIds: [7, 8, 12], emergentName: 'Product Stability Point', vortexStrength: 0.15, classification: 'neutral', tooltip: '87.5% uptime threatening credibility' },
                { id: 'V17', faceIds: [8, 9, 12], emergentName: 'Operational Survival', vortexStrength: 0.12, classification: 'neutral', tooltip: 'Operations barely maintaining' },
                { id: 'V18', faceIds: [9, 10, 12], emergentName: 'Values Resilience Point', vortexStrength: 0.25, classification: 'neutral', tooltip: 'Values providing some psychological resilience' },
                { id: 'V19', faceIds: [10, 11, 12], emergentName: 'Mission Survival Triangle', vortexStrength: 0.28, classification: 'hotspot', tooltip: 'Can mission clarity attract the funding needed to survive?' },
                { id: 'V20', faceIds: [7, 11, 12], emergentName: 'Pitch Survival Point', vortexStrength: 0.18, classification: 'neutral', tooltip: '3.5/5 pitch deck quality - potential' }
            ],
            shadowPatterns: [
        ...
        'zenith-solutions': {
            ...
            edges: [
                ...
                { id: 'E2-7', faceIds: [2, 7], emergentName: 'Story-Substance Alignment', elementalNature: 'Air', theQuestion: 'Does our brand story match our intellectual substance?', tension: 0.12 },
                ...
                { id: 'E3-8', faceIds: [3, 8], emergentName: 'Team Capacity Gap', elementalNature: 'Fire', theQuestion: 'Does our human energy sustainably fuel our operations?', tension: 0.23 },
                ...
                { id: 'E4-10', faceIds: [4, 10], emergentName: 'Governance Values Match', elementalNature: 'Ether', theQuestion: 'Does our governance embody our deepest values?', tension: 0.06 },
                { id: 'E5-6', faceIds: [5, 6], emergentName: 'Market Community Sync', elementalNature: 'Water', theQuestion: 'Is there healthy flow between our market presence and community?', tension: 0.03 },
                ...
                { id: 'E5-10', faceIds: [5, 10], emergentName: 'Market Values Alignment', elementalNature: 'Ether', theQuestion: 'Does our market perception align with our inner truth?', tension: 0.04 },
                { id: 'E5-11', faceIds: [5, 11], emergentName: 'Market Investor Story', elementalNature: 'Air', theQuestion: 'Does our market clarity attract aligned funding?', tension: 0.08 },
                ...
                { id: 'E6-11', faceIds: [6, 11], emergentName: 'Network to Capital', elementalNature: 'Water', theQuestion: 'Does our network generate funding opportunities?', tension: 0.05 },
                ...
                { id: 'E7-11', faceIds: [7, 11], emergentName: 'Brand Investor Appeal', elementalNature: 'Air', theQuestion: 'Does our brand story attract aligned capital?', tension: 0.10 },
                { id: 'E7-12', faceIds: [7, 12], emergentName: 'Brand Resilience Foundation', elementalNature: 'Fire', theQuestion: 'Is our brand a source of resilience in crisis?', tension: 0.12 },
                { id: 'E8-9', faceIds: [8, 9], emergentName: 'Operations Sustainability Debt', elementalNature: 'Water', theQuestion: 'Is there healthy regenerative flow in our operations?', tension: 0.36 },
                ...
                { id: 'E9-10', faceIds: [9, 10], emergentName: 'Values Sustainability Gap', elementalNature: 'Ether', theQuestion: 'Is our regenerative impulse grounded in our core values?', tension: 0.26 },
            ...
            // Full vertex data from mapping-context.json
            vertices: [
                { id: 'V1', faceIds: [1, 2, 3], emergentName: 'Funded Innovation Team', vortexStrength: 0.18, classification: 'hotspot', tooltip: 'Strong capital + IP but team stretched' },
                { id: 'V2', faceIds: [1, 3, 4], emergentName: 'Team Structure Capital', vortexStrength: 0.15, classification: 'neutral', tooltip: 'Resources present but structure catching up' },
                { id: 'V3', faceIds: [1, 4, 5], emergentName: 'Market Structure Capital', vortexStrength: 0.12, classification: 'synergy_hub', tooltip: 'Good alignment across growth dimensions' },
                { id: 'V4', faceIds: [1, 5, 6], emergentName: 'Community Market Capital', vortexStrength: 0.05, classification: 'synergy_hub', tooltip: 'EXCELLENT: Strong external coherence' },
                { id: 'V5', faceIds: [1, 2, 6], emergentName: 'Innovation Network Capital', vortexStrength: 0.06, classification: 'synergy_hub', tooltip: 'IP, partners, and capital aligned' },
                { id: 'V6', faceIds: [2, 3, 8], emergentName: 'Team Innovation Operations', vortexStrength: 0.22, classification: 'hotspot', tooltip: 'Strong ops + IP but team capacity strained' },
                { id: 'V7', faceIds: [3, 4, 9], emergentName: 'Team Structure Sustainability', vortexStrength: 0.12, classification: 'neutral', tooltip: 'Sustainability lagging team growth' },
                { id: 'V8', faceIds: [4, 5, 10], emergentName: 'Market Structure Values', vortexStrength: 0.08, classification: 'synergy_hub', tooltip: 'Good alignment of external presence with values' },
                { id: 'V9', faceIds: [5, 6, 11], emergentName: 'Network Market Funding', vortexStrength: 0.04, classification: 'synergy_hub', tooltip: 'EXCELLENT: Market + network driving funding' },
                { id: 'V10', faceIds: [2, 6, 7], emergentName: 'Brand IP Network', vortexStrength: 0.08, classification: 'synergy_hub', tooltip: 'Strong innovation story to market' },
                { id: 'V11', faceIds: [2, 7, 8], emergentName: 'Brand Operations IP', vortexStrength: 0.06, classification: 'synergy_hub', tooltip: 'Product excellence supports brand' },
                { id: 'V12', faceIds: [3, 8, 9], emergentName: 'Team Ops Sustainability Gap', vortexStrength: 0.28, classification: 'bermuda_triangle', tooltip: 'CRITICAL: Ops excellent but team stretched, sustainability neglected' },
                { id: 'V13', faceIds: [4, 9, 10], emergentName: 'Values Structure Sustainability', vortexStrength: 0.20, classification: 'hotspot', tooltip: 'Values present but sustainability practices lag' },
                { id: 'V14', faceIds: [5, 10, 11], emergentName: 'Market Values Funding', vortexStrength: 0.10, classification: 'synergy_hub', tooltip: 'Values-aligned market driving investment' },
                { id: 'V15', faceIds: [6, 7, 11], emergentName: 'Network Brand Funding', vortexStrength: 0.06, classification: 'synergy_hub', tooltip: 'Partner network amplifying investor interest' },
                { id: 'V16', faceIds: [7, 8, 12], emergentName: 'Brand Ops Resilience', vortexStrength: 0.12, classification: 'neutral', tooltip: 'Strong ops but resilience developing' },
                { id: 'V17', faceIds: [8, 9, 12], emergentName: 'Ops Sustainability Resilience Gap', vortexStrength: 0.30, classification: 'bermuda_triangle', tooltip: 'CRITICAL: Excellent ops but sustainability debt accumulating' },
                { id: 'V18', faceIds: [9, 10, 12], emergentName: 'Values Sustainability Resilience', vortexStrength: 0.18, classification: 'hotspot', tooltip: 'Values strong but sustainability practices need development' },
                { id: 'V19', faceIds: [10, 11, 12], emergentName: 'Values Funding Resilience', vortexStrength: 0.16, classification: 'neutral', tooltip: 'Strong funding provides resilience buffer' },
                { id: 'V20', faceIds: [7, 11, 12], emergentName: 'Brand Funding Fortress', vortexStrength: 0.14, classification: 'neutral', tooltip: 'Brand + capital provide some protection' }
            ],
            shadowPatterns: [
        ...
        'apex-industries': {
            ...
            edges: [
                ...
                { id: 'E2-7', faceIds: [2, 7], emergentName: 'Story-Substance Unity', elementalNature: 'Air', theQuestion: 'Does our brand story match our intellectual substance?', tension: 0.03 },
                ...
                { id: 'E3-8', faceIds: [3, 8], emergentName: 'Work as Joy', elementalNature: 'Fire', theQuestion: 'Does our human energy sustainably fuel our operations?', tension: 0.02 },
                ...
                { id: 'E4-10', faceIds: [4, 10], emergentName: 'Governance Values Unity', elementalNature: 'Ether', theQuestion: 'Does our governance embody our deepest values?', tension: 0.07 },
                { id: 'E5-6', faceIds: [5, 6], emergentName: 'Market Community Harmony', elementalNature: 'Water', theQuestion: 'Is there healthy flow between our market presence and community?', tension: 0.07 },
                ...
                { id: 'E5-10', faceIds: [5, 10], emergentName: 'Market Truth Alignment', elementalNature: 'Ether', theQuestion: 'Does our market perception align with our inner truth?', tension: 0.09 },
                { id: 'E5-11', faceIds: [5, 11], emergentName: 'Market Attracts Capital', elementalNature: 'Air', theQuestion: 'Does our market clarity attract aligned funding?', tension: 0.02 },
                ...
                { id: 'E6-11', faceIds: [6, 11], emergentName: 'Network as Capital Magnet', elementalNature: 'Water', theQuestion: 'Does our network generate funding opportunities?', tension: 0.05 },
                ...
                { id: 'E7-11', faceIds: [7, 11], emergentName: 'Brand Investor Attraction', elementalNature: 'Air', theQuestion: 'Does our brand story attract aligned capital?', tension: 0.02 },
                { id: 'E7-12', faceIds: [7, 12], emergentName: 'Brand Fortress', elementalNature: 'Fire', theQuestion: 'Is our brand a source of resilience in crisis?', tension: 0.03 },
                { id: 'E8-9', faceIds: [8, 9], emergentName: 'Operations as Earth Service', elementalNature: 'Water', theQuestion: 'Is there healthy regenerative flow in our operations?', tension: 0.02 },
                ...
                { id: 'E9-10', faceIds: [9, 10], emergentName: 'Regeneration Values Unity', elementalNature: 'Ether', theQuestion: 'Is our regenerative impulse grounded in our core values?', tension: 0.01 },
            ...
            // Full vertex data from mapping-context.json
            vertices: [
                { id: 'V1', faceIds: [1, 2, 3], emergentName: 'Resourced Flourishing Wisdom', vortexStrength: 0.02, classification: 'synergy_hub', tooltip: 'HARMONY: Capital, knowledge, and people in perfect flow' },
                { id: 'V2', faceIds: [1, 3, 4], emergentName: 'Empowered Structure', vortexStrength: 0.03, classification: 'synergy_hub', tooltip: 'Resources, people, and governance aligned' },
                { id: 'V3', faceIds: [1, 4, 5], emergentName: 'Market Capital Governance', vortexStrength: 0.04, classification: 'synergy_hub', tooltip: 'External and internal coherence' },
                { id: 'V4', faceIds: [1, 5, 6], emergentName: 'Ecosystem Capital Market', vortexStrength: 0.05, classification: 'synergy_hub', tooltip: 'Strong community-market-capital flow' },
                { id: 'V5', faceIds: [1, 2, 6], emergentName: 'Knowledge Capital Network', vortexStrength: 0.02, classification: 'synergy_hub', tooltip: 'IP, capital, and community in harmony' },
                { id: 'V6', faceIds: [2, 3, 8], emergentName: 'Team Learning Excellence', vortexStrength: 0.01, classification: 'synergy_hub', tooltip: 'PERFECT: People, knowledge, operations unified' },
                { id: 'V7', faceIds: [3, 4, 9], emergentName: 'Human Structure Regeneration', vortexStrength: 0.06, classification: 'synergy_hub', tooltip: 'People flourishing within regenerative structures' },
                { id: 'V8', faceIds: [4, 5, 10], emergentName: 'Structure Market Values', vortexStrength: 0.07, classification: 'synergy_hub', tooltip: 'Values visible in governance and market' },
                { id: 'V9', faceIds: [5, 6, 11], emergentName: 'Network Market Capital', vortexStrength: 0.04, classification: 'synergy_hub', tooltip: 'Ecosystem driving sustainable growth' },
                { id: 'V10', faceIds: [2, 6, 7], emergentName: 'Brand Knowledge Network', vortexStrength: 0.02, classification: 'synergy_hub', tooltip: 'IP story shared through community' },
                { id: 'V11', faceIds: [2, 7, 8], emergentName: 'Brand IP Operations', vortexStrength: 0.03, classification: 'synergy_hub', tooltip: 'Operational excellence tells brand story' },
                { id: 'V12', faceIds: [3, 8, 9], emergentName: 'Human Ops Regeneration', vortexStrength: 0.03, classification: 'synergy_hub', tooltip: 'Work as service, people flourishing' },
                { id: 'V13', faceIds: [4, 9, 10], emergentName: 'Governance Regeneration Values', vortexStrength: 0.05, classification: 'synergy_hub', tooltip: 'Structure serves regeneration and values' },
                { id: 'V14', faceIds: [5, 10, 11], emergentName: 'Market Values Capital', vortexStrength: 0.08, classification: 'synergy_hub', tooltip: 'Values visible in market attracting capital' },
                { id: 'V15', faceIds: [6, 7, 11], emergentName: 'Network Brand Funding', vortexStrength: 0.04, classification: 'synergy_hub', tooltip: 'Community amplifying brand to capital' },
                { id: 'V16', faceIds: [7, 8, 12], emergentName: 'Brand Ops Fortress', vortexStrength: 0.03, classification: 'synergy_hub', tooltip: 'Operations and brand building resilience' },
                { id: 'V17', faceIds: [8, 9, 12], emergentName: 'Ops Regeneration Antifragile', vortexStrength: 0.02, classification: 'synergy_hub', tooltip: 'Operations healing Earth, building strength' },
                { id: 'V18', faceIds: [9, 10, 12], emergentName: 'Values Regeneration Fortress', vortexStrength: 0.02, classification: 'synergy_hub', tooltip: 'Values and regeneration as antifragile core' },
                { id: 'V19', faceIds: [10, 11, 12], emergentName: 'Values Capital Fortress', vortexStrength: 0.05, classification: 'synergy_hub', tooltip: 'Values attracting capital building resilience' },
                { id: 'V20', faceIds: [7, 11, 12], emergentName: 'Brand Capital Fortress', vortexStrength: 0.04, classification: 'synergy_hub', tooltip: 'Brand and capital providing protection' }
            ],
            shadowPatterns: [
